...
function downloadItem(ev) {
  ...
  fetch(this.targetUrl, { method: 'GET' }).then((res) => {
    // res.urlは以下のようになっている
    // https://cfvod.kaltura.com/scf/pd/p/2075011/sp/207501100/serveFlavor/entryId/1_ghd6zt6f/v/1/ev/3/flavorId/1_wer2zx8g/fileName/{全角文字等が_で置き換えられている}_(Source).mp4/name/a.mp4?{以下トークン}
